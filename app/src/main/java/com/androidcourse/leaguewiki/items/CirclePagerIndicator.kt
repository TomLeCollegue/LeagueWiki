...
// src : https://stackoverflow.com/questions/33841363/how-to-make-a-page-indicator-for-horizontal-recyclerview
class CirclePagerIndicator(@ColorInt private val colorActive: Int, @ColorInt private val colorInactive: Int) : ItemDecoration() {
    ...
    override fun onDrawOver(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        val indicatorPosY = (parent.height - mIndicatorHeight).toFloat()
    ...
    override fun getItemOffsets(outRect: Rect, view: View, parent: RecyclerView, state: RecyclerView.State) {
        ...
        outRect.bottom = (mIndicatorHeight + DP * 18).toInt()
    }
